...
void SingleImageAquisition(int cameratyp , char* filename, WORD** bufferContent )
{
	cout << filename << endl;
	...
	else
	{
		...
		*bufferContent = new WORD[bufferList.size() * (sizeof bufferList[0])];

		for (int i = 0; i < bufferList.size(); i++)
			(*bufferContent)[i] = *bufferList.at(i);
		...
		cout << *bufferContent[0] << endl;
		cout << *bufferContent[1] << endl;
		cout << *bufferContent[2] << endl;
		cout << *bufferContent[3] << endl;
