...
void SingleImageAquisition(int cameratyp , char* filename, WORD* datapack1, WORD* datapack2, WORD* datapack3, WORD* datapack4)
{
	cout << filename << endl;
	...
	else
	{
		...
		datapack1 = bufferList.at(0);
		datapack2 = bufferList.at(1);
		datapack3 = bufferList.at(2);
		datapack4 = bufferList.at(3);
