...
DataPack_FLIM* FLimCameraLiveView()
{
	...
	vector<WORD*>bufferList = pmicIm_2->Live_View(2, flimCameraPointer, flimCameraRecorderPointer , &imgWidth, &imgHeight);

	int imageSize = (__int64)imgWidth * (__int64)imgHeight;
	datapack->width = imgWidth;
	datapack->height = imgHeight;
	datapack->buffersize = imageSize;
