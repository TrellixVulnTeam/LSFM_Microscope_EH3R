...
public:
	...
	virtual std::vector<WORD*> SingleImageAquisition(int cameraTyp, HANDLE recorder, HANDLE camera, int phaseNumber, int phasesymmetry, int tapSelect, char* file_name) = 0;
