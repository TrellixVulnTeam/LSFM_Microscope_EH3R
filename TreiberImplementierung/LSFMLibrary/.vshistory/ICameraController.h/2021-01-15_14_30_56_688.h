...
public:
	...
	virtual void SingleImageAquisition(CameraTyp cameraTyp , HANDLE camera, PhaseNumber phaseNumber, PhaseSymmetry phasesymmetry , TapSelect* tapSelect, char* file_name) = 0;
