...
public:
	...
	virtual bool SingleImageAquisition(int cameraTyp, HANDLE recorder, HANDLE camera, int phaseNumber, int phasesymmetry, int tapSelect, char* file_name) = 0;
	...
	virtual bool SetFilmPhaseSequenceParameter(PhaseNumber phaseNumber, PhaseSymmetry phasesymmetry, PhaseOrder phaseOrder, TapSelect tapSelect, DWORD frequency) = 0;
	...
	virtual bool Set_Camera_Master_modulation_frequency(DWORD frequency) = 0;
