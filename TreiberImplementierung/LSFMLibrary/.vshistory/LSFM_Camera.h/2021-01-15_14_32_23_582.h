...
public:
	...
	bool GetAndSave_Image(CameraTyp cameraTyp, HANDLE camera, PhaseNumber phaseNumber, PhaseSymmetry phasesymmetry, TapSelect tapSelect, char* file_name);
	...
	WORD GetExposureAndDelayTime(HANDLE camera) override;

	void SetExposureTime(HANDLE camera, DWORD value, DWORD unit) override;

	void add(Component* component) override;

	void remove(Component* component) override;

	void SingleImageAquisition(CameraTyp cameraTyp, HANDLE camera, PhaseNumber phaseNumber, PhaseSymmetry phasesymmetry, TapSelect* tapSelect, char* file_name) override;

	void Start_Sequence(HANDLE camera) override;

	DataPack* Live_View(HANDLE camera, HANDLE recorder) override;
