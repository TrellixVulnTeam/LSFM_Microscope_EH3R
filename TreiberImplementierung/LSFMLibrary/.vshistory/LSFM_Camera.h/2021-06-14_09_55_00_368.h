...
public:
	...
	bool SetFilmPhaseSequenceParameter(PhaseNumber phaseNumber, PhaseSymmetry phasesymmetry, PhaseOrder phaseOrder, TapSelect tapSelect, DWORD frequency) override;
	...
	bool Set_Camera_Master_modulation_frequency(DWORD frequency) override;
