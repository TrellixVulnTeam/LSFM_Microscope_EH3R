...
extern "C" LSFMLIBRARY_API  void SingleImageAquisition(int cameratyp, char* filename, DataPack * datapack1, DataPack * datapack2, DataPack * datapack3, DataPack * datapack4);
...
extern "C" LSFMLIBRARY_API void Image_Sequence(const char* path, double zUp, double zDown, double xValue, double yValue, double focusUp, double focusDown, int N, double dz);
