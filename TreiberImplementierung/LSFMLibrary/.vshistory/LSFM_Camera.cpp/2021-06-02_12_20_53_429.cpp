...
#
							...
							else if (cameraTyp == 2)
							{
								...
								if (IsNoErrorOccured(iRet, "Error with the Acquisition of the flim Parameters"))
								{
									...
									cout << L << endl;
									datapack->imgNumber = (_int64)L;

									WORD* imgBuffer1 = new WORD[(__int64)this->imgWidth * (__int64)this->imgHeight];
									WORD* imgBuffer2 = new WORD[(__int64)this->imgWidth * (__int64)this->imgHeight];
									WORD* imgBuffer3 = new WORD[(__int64)this->imgWidth * (__int64)this->imgHeight];
									WORD* imgBuffer4 = new WORD[(__int64)this->imgWidth * (__int64)this->imgHeight];

									Sleep(10);

									iRet = PCO_RecorderCopyImage(recorder, hCamArr[0], PCO_RECORDER_LATEST_IMAGE, 1, 1, this->imgWidth, this->imgHeight, imgBuffer1, NULL, &metadata, NULL);
									datapack->bufferptr1 = imgBuffer1;

									/*
									iRet = PCO_RecorderCopyImage(recorder, hCamArr[0], 1, 1, 1, this->imgWidth, this->imgHeight, imgBuffer1, NULL, &metadata, NULL);
									datapack->bufferptr2 = imgBuffer2;

									iRet = PCO_RecorderCopyImage(recorder, hCamArr[0], 2, 1, 1, this->imgWidth, this->imgHeight, imgBuffer1, NULL, &metadata, NULL);
									datapack->bufferptr3 = imgBuffer3;

									iRet = PCO_RecorderCopyImage(recorder, hCamArr[0], 3, 1, 1, this->imgWidth, this->imgHeight, imgBuffer1, NULL, &metadata, NULL);
									datapack->bufferptr4 = imgBuffer4;
									*/

									//PCO_RecorderStopRecord(recorder, camera);
