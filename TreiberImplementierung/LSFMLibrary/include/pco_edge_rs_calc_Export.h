...
DWORD RS_CONV_CEXP PCO_RS_Set_Random_Off(HANDLE ph,unsigned int offset);
...
DWORD RS_CONV_CEXP PCO_RS_Get_Random_Off(HANDLE ph,unsigned int *offset);
...
DWORD RS_CONV_CEXP PCO_RS_Calculate_SB_Off(HANDLE ph,int width,int height,unsigned short *pic_InOut,unsigned int *off);
//Calculate image from a raw pco.edge RollingShutter image, which does contain the packed 
//data image with sorted lines, Calculation is done in place 
//
//in:
...
DWORD RS_CONV_CEXP PCO_RS_Calculate_Format_Off(HANDLE ph,int Dataformat,int width,int height,unsigned short *picin,unsigned short *picout,unsigned int *off);
//Calculate image from a raw pco.edge RollingShutter image, which does contain the packed 
//data image in format DataFormat
//
//in:
