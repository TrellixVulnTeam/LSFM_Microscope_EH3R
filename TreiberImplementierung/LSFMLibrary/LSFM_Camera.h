...
public:
	...
	bool SingleImageAquisition(char* file_name) override;

	void Start_Sequence() override;

	DataPack* Live_View() override;

	bool SetFlimPhaseSequenceParameter(PhaseNumber phaseNumber, PhaseSymmetry phasesymmetry, PhaseOrder phaseOrder, TapSelect tapSelect, DWORD frequency) override;
	...
	int GetCameraIdentification() override;
