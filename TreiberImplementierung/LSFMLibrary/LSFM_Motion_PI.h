...
public:
	...
	bool MoveRelativXYZ(int stage, double position, bool acquisitionRunning) override;

	bool MoveAbsolutXYZ(int stage, double position, bool acquisitionRunning) override;

	int GetStage() override;

	void getIdentification(char* identificationValue);


	void Disconnect() override;

	bool GetMotionStatusConnection() override;
