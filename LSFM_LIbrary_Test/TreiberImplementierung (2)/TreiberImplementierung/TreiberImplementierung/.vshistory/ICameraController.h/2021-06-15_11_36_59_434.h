...
public:
	...
	virtual std::vector<WORD*> Live_View(int cameraTyp, HANDLE camera, HANDLE recorder, int* img_width, int* img_Height) = 0;
	...
	virtual int GetCameraIdentification(HANDLE* camera) = 0;
