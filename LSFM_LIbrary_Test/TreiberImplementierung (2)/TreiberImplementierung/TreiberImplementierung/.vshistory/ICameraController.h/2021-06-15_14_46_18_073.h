...
public:
	...
	virtual bool SingleImageAquisition(int phaseNumber, int phasesymmetry, int tapSelect, char* file_name) = 0;
	...
	virtual std::vector<WORD*> Live_View(int* img_width, int* img_Height) = 0;
	virtual void Start_Sequence() = 0;
	virtual bool SetFlimPhaseSequenceParameter(PhaseNumber phaseNumber, PhaseSymmetry phasesymmetry, PhaseOrder phaseOrder, TapSelect tapSelect) = 0;
