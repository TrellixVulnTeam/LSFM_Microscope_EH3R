...
public:
	...
	vector<WORD*> Live_View(int cameraTyp,  HANDLE camera, HANDLE recorder, int* img_width, int* img_Height) override;
	...
	int GetCameraIdentification(HANDLE* camera) override;
};
