...
public:
	...
	vector<WORD*> GetAndSave_Image(CameraTyp cameraTyp, HANDLE recorder, HANDLE camera, PhaseNumber phaseNumber, PhaseSymmetry phasesymmetry, TapSelect tapSelect, char* file_name);
	...
	void GetExposureAndDelayTime(HANDLE camera, WORD* expousreTime, WORD* exposuretimeBase) override;
	...
	vector<WORD*> SingleImageAquisition(int cameraTyp, HANDLE recorder, HANDLE camera, int phaseNumber, int phasesymmetry, int tapSelect, char* file_name) override;
