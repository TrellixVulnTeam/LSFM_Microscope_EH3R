...
const char* motionsConfigFile = "C:\\Users\\User\\Documents\\TreiberImplementierung (2)\\TreiberImplementierung\\TreiberImplementierung\\ConfigFile.txt";

vector<LSFM_Motion_PI> controllers = controllerDetection(szUSB, 299, motionsConfigFile);


vector<LSFM_Laser> lasers = LaserPortDetection(laserConfigFile);
