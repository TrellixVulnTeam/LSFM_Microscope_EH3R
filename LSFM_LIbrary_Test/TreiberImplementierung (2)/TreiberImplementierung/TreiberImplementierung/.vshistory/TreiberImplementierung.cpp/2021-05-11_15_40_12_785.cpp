...
int main()
{
	...
	vector<WORD*> bufferList = flimCameracontroller->SingleImageAquisition(2, camRecorderHandle, camHandle, PhaseNumber::Four, PhaseSymmetry::twice, TapSelect::both, filenemame);

	 WORD* imgBuffer1 = bufferList[0];
	 WORD* imgBuffer2 = bufferList[1];
	 WORD* imgBuffer3 = bufferList[2];
	 WORD* imgBuffer4 = bufferList[3];


		
	 char filenemame4[100];
	 sprintf_s(filenemame4, "test1.tif");
	 int  iRet = PCO_RecorderSaveImage(imgBuffer1, 1008, 1008, FILESAVE_IMAGE_BW_16, false, filenemame4, true, nullptr);
	 char filenemame1[100];
	 sprintf_s(filenemame1, "test2.tif");
	   iRet = PCO_RecorderSaveImage(imgBuffer2, 1008, 1008, FILESAVE_IMAGE_BW_16, false, filenemame1, true, nullptr);
	 char filenemame2[100];
	 sprintf_s(filenemame2, "test3.tif");
	   iRet = PCO_RecorderSaveImage(imgBuffer3, 1008, 1008, FILESAVE_IMAGE_BW_16, false, filenemame2, true, nullptr);
	 char filenemame3[100];
	 sprintf_s(filenemame3, "test4.tif");
	   iRet = PCO_RecorderSaveImage(imgBuffer4, 1008, 1008, FILESAVE_IMAGE_BW_16, false, filenemame3, true, nullptr);
