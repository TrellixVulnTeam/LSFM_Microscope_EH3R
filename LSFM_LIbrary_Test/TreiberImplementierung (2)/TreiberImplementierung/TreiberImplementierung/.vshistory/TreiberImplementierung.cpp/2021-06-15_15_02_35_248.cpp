...
void DarkModeImageSequence(const char* path)
{
	...
	//pmlaser2->LaserOff();
		...
		cameracontroller->SingleImageAquisition(4, 2, 0, filename);
		Sleep(1000);
...
void Live_View()
{
	...
	vector<WORD*>bufferList = flimCameracontroller->Live_View(&imgWidth,&imgHeight);
...
int main()
{
	...
	char filenemame[100];
	sprintf_s(filenemame, "C:\\Users\\admin\\Desktop\\image_0000");
	//cameracontroller->SingleImageAquisition(NULL, NULL, NULL, filenemame);
	//flimCameracontroller->SingleImageAquisition(NULL, NULL, NULL, filenemame);
